...
from FClip.postprocess import postprocess
...
def main():
    ...
    inames = sorted(glob.glob("/home/dxl/Data/wireframe/valid/*.png"))
    gts = sorted(glob.glob("/home/dxl/Data/wireframe/valid/*_label.npz"))
